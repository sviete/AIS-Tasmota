...
const char HTTP_END[] PROGMEM =
  "<div style='text-align:right;font-size:11px;'><hr/><a href='https://ai-speaker.com' target='_blank' style='color:#aaa;'>AIS dom, na bazie Sonoff-Tasmota %s " D_BY " Theo Arends</a></div>"
  "</div>"
  "</body>"
  "</html>";
